...
namespace IntegrationLibrary.Core.Model.MailRequests
{
    public class TenderWinnermailRequest : MailRequest
    {
        public TenderWinnermailRequest(BloodBank bank, Tender.Tender tender)
        {
            ...
            Body = Body.Replace("{{Delivery_Date}}", winningBid.DeliveryDate.ToString("D"));
            Body = Body.Replace("{{Price}}", winningBid.Price.ToString());
        }
                          ...
                          <tr>
                            <td class=""content-cell"">
                              <div class=""f-fallback"">
                                ...
                                <p>You have won the bid on Tender with ID: {{Tender_ID}}</p>
