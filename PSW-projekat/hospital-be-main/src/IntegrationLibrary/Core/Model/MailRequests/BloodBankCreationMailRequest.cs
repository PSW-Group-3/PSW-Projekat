...
namespace IntegrationLibrary.Core.Model.MailRequests
{
    public class BloodBankCreationMailRequest : MailRequest
    {
        public BloodBankCreationMailRequest(BloodBank bank)
        {
            ...
            Body = Body.Replace("{{name}}", bank.Name);
            Body = Body.Replace("{{username}}", bank.Email.EmailAddress);
            Body = Body.Replace("{{password}}", bank.Password);
            Body = Body.Replace("{{api_key}}", bank.ApiKey);
            Body = Body.Replace("{{activation_link}}", "http://localhost:4200/blood-bank-change-password?passKey=" + bank.PasswordResetKey);
        }
                ...
                <td align=""center"">
                    ...
                    <tr>
                          ...
                          <tr>
                            <td class=""content-cell"">
                              <div class=""f-fallback"">
                                <h1>Welcome, {{name}}!</h1>
                                <p>Thanks for joining our Hospital. We’re thrilled to have you on board</p>
                      ...
                      <strong>Api key:</strong> {{api_key}}
                                ...
                                <p>You have to activate your account. To do this you need to follow the following link:</p>
                                <table class=""attributes"" width=""100%"" cellpadding=""0"" cellspacing=""0"" role=""presentation"">
                                  <tr>
                                    <td class=""attributes_content"">
                                      <table width=""100%"" cellpadding=""0"" cellspacing=""0"" role=""presentation"">
                                        <tr>
                                          <td class=""attributes_item"">
                                            <span class=""f-fallback"">
                      <strong>Activation Link:</strong> {{activation_link}}
                    </span>
                                          </td>
                                        </tr>
                                      </table>
