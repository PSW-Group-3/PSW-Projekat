...
namespace HospitalTests.Integration
{
    public class AggregateEventSourcingForSchedulingByPatientTest : IClassFixture<StatisticsTestDatabaseFactory<Startup>>
    {
        ...
        public void patient_back_to_date()
        {
            ...
            //Act
            var result = ((OkResult)controller.BackToAppointmentDateChoosing(new AppointmentSchedulingEventDTO() { Id = 1, SelectedItem = "" }));
        ...
        public void end_event_sourcing_aggregate()
        {
            ...
            //Act
            var result = ((OkResult)controller.AppointmentSchedulingAggregateEndTime(new AppointmentSchedulingEventDTO() { Id = 1, SelectedItem = "" }));
